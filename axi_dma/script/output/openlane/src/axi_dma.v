module axi_dma #(
    ...
    parameter DMA_LENGTH_W      = 8,   // Maximum size of 1 transfer is (2^16 * 256) 
    parameter DMA_DESC_DEPTH    = 2,    // The maximum number of descriptors in each channel
    ...
    parameter DST_TDEST_W       = 1,
    parameter ATX_DST_DATA_W    = 256,
    // AXI Slave
    parameter S_DATA_W          = 32,
    parameter S_ADDR_W          = 32,
    // AXI BUS 
    parameter MST_ID_W          = 1,
    ...
    parameter ATX_INTL_DEPTH    = 2 // Interleaving depth on the AXI data channel 
) (
    input                           aclk,
    input                           aresetn,
